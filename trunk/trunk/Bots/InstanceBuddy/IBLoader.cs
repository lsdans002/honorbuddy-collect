    ...
    public class IBLoader : BotBase
    {
        ...
        public IBLoader()
        {
			try
			{
				...
				string path = Logging.ApplicationPath + @"\Bots\Instancebuddy\Instancebuddy.dll";
			...
			{
				Logging.Write(Color.DarkRed, "An error occured while loading Instancebuddy");
