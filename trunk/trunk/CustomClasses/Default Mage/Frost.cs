    ...
    public partial class DefaultMage
    {
        ...
        private Composite Frost_rotation()
        {
            return new PrioritySelector(
               ...
               new Decorator(ret => Me.CurrentTarget != null && Me.CurrentTarget.Distance < 6 && Battlegrounds.IsInsideBattleground && SpellManager.CanCast("Frost Nova"),
                   new Sequence(
               ...
               new Decorator(ret => Me.CurrentTarget != null && !HasSheeped() && Me.CurrentTarget.HealthPercent >= 10 && Me.CurrentTarget.Distance < 6 && !Me.IsInInstance && !Battlegrounds.IsInsideBattleground && SpellManager.CanCast("Frost Nova"),
                   new Sequence(
                       new Action(ret => SpellManager.Cast("Frost Nova")),
                ...
                //CounterSpell
             new Decorator(ret => Me.CurrentTarget != null && SpellManager.HasSpell("Counterspell") && SpellManager.CanCast("Counterspell") && Me.CurrentTarget.IsCasting,
                   new PrioritySelector(
            ...
            new Decorator(ret => LegacySpellManager.KnownSpells.ContainsKey("Evocation") && SpellManager.CanCast("Evocation") && Me.ManaPercent < 30 && (!SpellManager.HasSpell("Mana Shield") || Me.Auras.ContainsKey("Mana Shield") || Me.Auras.ContainsKey("Ice Barrier")),
               ...
               new Decorator(ret => Me.CurrentTarget != null && SpellManager.CanCast("Fire Blast", true) && Me.CurrentTarget.HealthPercent <= 20,
                    new PrioritySelector(
